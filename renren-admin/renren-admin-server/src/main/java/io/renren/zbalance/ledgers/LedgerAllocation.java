...
public class LedgerAllocation {
    ...
    public void ledgeM2s(JAllocateEntity entity) {
        ...
        // 记账1: 商户Va-
        ledgerUtil.ledgeUpdate(mVa, LedgerConstant.ORIGIN_TYPE_ALLOCATE_M2S, LedgerConstant.FACT_M2S_OUT_VA, entity.getId(), factMemo, entity.getAmount().negate());
        ledgerUtil.ledgeUpdate(sVa, LedgerConstant.ORIGIN_TYPE_ALLOCATE_M2S, LedgerConstant.FACT_M2S_IN_SUB_VA, entity.getId(), factMemo, entity.getAmount());
    }
    ...
    public void ledgeS2m(JAllocateEntity entity) {
        ...
        // 记账1: 子商户Va-
        ledgerUtil.ledgeUpdate(sVa, LedgerConstant.ORIGIN_TYPE_ALLOCATE_S2M, LedgerConstant.FACT_S2M_OUT_SUB_VA, entity.getId(), factMemo, entity.getAmount().negate());
        // 记账2: 商户Va+
        ledgerUtil.ledgeUpdate(mVa, LedgerConstant.ORIGIN_TYPE_ALLOCATE_S2M, LedgerConstant.FACT_S2M_IN_VA, entity.getId(), factMemo, entity.getAmount());
    }
}