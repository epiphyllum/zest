...
public class LedgerConstant {
    ...
    public static final int FACT_CARD_CHARGE_IN_CHARGE_SUM = 60005;    // 7. 累计发起充值金额
    public static final int FACT_CARD_CHARGE_IN_DEPOSIT_SUM = 60006;   // 8. 累计保证金金额
    public static final int FACT_CARD_CHARGE_IN_FEE_SUM = 60007;       // 9. 累计手续费金额
    ...
    public static final int FACT_CARD_WITHDRAW_OUT_FEE_SUM = 70007;            // 退手续费
    public static final int FACT_CARD_WITHDRAW_OUT_CHARGE_SUM = 70008;         // 退充值资金资金
