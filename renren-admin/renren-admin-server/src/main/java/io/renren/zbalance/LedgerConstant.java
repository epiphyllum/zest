...
public class LedgerConstant {
    ...
    public static final int FACT_CARD_WITHDRAW_FREEZE_CARD_SUM = 70000;                  // 0. 子商户-卡汇总资金账户(冻结)
    public static final int FACT_CARD_WITHDRAW_UNFREEZE_CARD_SUM = 70001;                // 1. 子商户-卡汇总资金账户(解冻)
    public static final int FACT_CARD_WITHDRAW_CONFIRM_CARD_SUM = 70002;                 // 2. 子商户-卡汇总资金账户(确认成功)
    public static final int FACT_CARD_WITHDRAW_IN_SUB_VA = 70003;                        // 3. 子商户-VA+
    public static final int FACT_CARD_WITHDRAW_OUT_CHARGE = 70004;                       // 4. 子商户-退手续费-
    public static final int FACT_CARD_WITHDRAW_OUT_AIP_CHARGE = 70005;                   // 5. 通联-退手续费
    public static final int FACT_CARD_WITHDRAW_OUT_AIP_CARD_SUM = 70006;                 // 6. 通联-卡汇总资金
    public static final int FACT_CARD_WITHDRAW_FREEZE_PREPAID_QUOTA = 70007;             // 7. 如果是预防费主卡: 预付费主卡可以余额减少
    public static final int FACT_CARD_WITHDRAW_UNFREEZE_PREPAID_QUOTA = 70008;           // 8. 如果是预防费主卡: 预付费主卡可以余额减少
    public static final int FACT_CARD_WITHDRAW_OUT_PREPAID_QUOTA = 70009;                // 9. 如果是预防费主卡: 预付费主卡可以余额减少
    // 商户VA提现
