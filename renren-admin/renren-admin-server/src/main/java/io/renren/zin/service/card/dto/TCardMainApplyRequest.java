...
// 主卡申请
@Data
public class TCardMainApplyRequest {
    ...
    private	String	cardtype	;//	卡片种类	1：虚拟卡，（产品类型为：通华金服VISA虚拟卡、通华VPA电子卡）4：虚实同发，（产品类型为：通华金服VISA公务卡、万商义乌VISA商务卡）
    ...
    private	String	idtype	;//	证件1类型	01：居民身份证（国籍为中国）04：护照（国籍为非中国）
    private	String	idnumber	;//	证件1号码
    private	String	idtype2	;//	证件2类型	国籍不为中国时必填01：居民身份证02：军人或武警身份证03：港澳台通行证04：护照05：其他有效旅行证件06：其他类个人有效证件
    private	String	idnumber2	;//	证件2号码	国籍不为中国时必填
