package io.renren.zapi.service.account;
...
import io.renren.zapi.service.account.dto.*;
...
import io.renren.zin.service.money.dto.*;
...
public class ApiAccountService {
    ...
    public Result<VaDepositApplyResponse> depositApply(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        // 请求通联
        TVaDepositApplyResponse response = zinMoneyService.depositApply(tVaDepositApply);
    ...
    public Result<VaDepositConfirmResponse> depositConfirm(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        TVaDepositConfirmResponse tVaDepositConfirmResponse = zinMoneyService.depositConfirm(tVaDepositConfirm);
    ...
    public Result<SubmitMaterialResponse> submitMaterial(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        TSubmitMaterialResponse tSubmitMaterialResponse = zinMoneyService.submitMaterial(tSubmitMaterial);
    ...
    public Result<MoneyAccountAddResponse> addMoneyAccount(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        TMoneyAccountAddResponse tMoneyAccountAddResponse = zinMoneyService.addMoneyAccount(tMoneyAccountAdd);
    ...
    public Result<MoneyAccountUpdateResponse> updateMoneyAccount(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        TMoneyAccountUpdateResponse tMoneyAccountUpdateResponse = zinMoneyService.updateMoneyAccount(tMoneyAccountUpdate);
    ...
    public Result<MoneyAccountQueryResponse> queryMoneyAccount(Long merchantId, String reqId, String name, String body, String sign) {
        ...
        TMoneyAccountQueryResponse response = zinMoneyService.queryMoneyAccount(tMoneyAccountQuery);
