...
(
    id             bigint         not null,
    dept_id        bigint         not null comment '子商户ID',
    dept_name      varchar(32)    not null comment '子商户',
...
(
    id             bigint      not null comment 'ID',
    dept_id        bigint      not null comment '商户ID',
    dept_name      varchar(32) not null comment '商户名',
...
--  hkd -> va
drop table if exists j_inout;
create table j_inout
(
    id          bigint         not null comment 'ID',
    dept_id     bigint         not null comment '商户ID',
    dept_name   varchar(50)    not null comment '商户名称',

    type        varchar(32)    not null comment 'i2v, v2i, m2s, s2m',
    amount      decimal(18, 2) not null comment '金额',
    currency    varchar(3)     not null comment '币种',
    from_id     bigint         not null comment '出金账户',
    to_id       bigint         not null comment '入金账户',
  ...
  collate utf8mb4_bin
  DEFAULT CHARACTER SET utf8mb4 COMMENT ='j_inout';
create index idx_j_inout on j_inout (dept_id, create_date);
